...
[[webgpu-e2e|WebGPU browser e2e lane]], [[instancing-strategy|Instancing
strategy]], [[source-organization|Source organization]].
...
opt-in [[webgpu-e2e|WebGPU e2e lane]] depends on this probe to stay
non-flaky.
