...
| FE node annotations                                                                                                                | renderer + demo           | same       | **Core now** | Node glyphs respect scene depth: nearer faces hide occluded nodes, while front-facing or coincident nodes overlay faces and edges cleanly.                                                                |
