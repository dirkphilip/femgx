...
| Derived engineering quantities, vector/tensor glyphs, results playback, interpolation, and legends                           | —                  | —          | **Deferred** | No femgx-derived magnitude/stress/principal values or result glyph subsystem in the current product.                                                                                                                                                                                                                                      |
