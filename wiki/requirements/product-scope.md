...
| FE node annotations                                                                                                                | renderer + demo           | same       | **Core now** | Center-depth classification hides occluded nodes and draws complete 4 px front glyphs without zoom-dependent depth offsets.                                                                               |
