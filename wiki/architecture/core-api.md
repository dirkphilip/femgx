...
| Elements    | `createElement`, `ElementModel`, `ElementBlock`, `Body`, `createElementModel`, `ElementModelValidationError`, `heterogeneousElementParts`, `boundaryFaceRefs`, `FaceIdRef`, `ElementShape`                      | Validated FE connectivity (Point, Line, Line3, Triangle, Tri6, Quad, Quad8, Tet4, Tet10, Hex8, Hex20), optional semantic block/body ownership, canonical topology, mixed primitive grouping, and face selection inputs. |
