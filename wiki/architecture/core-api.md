...
| Area        | Core API                                                                                                                               | Owns                                                                                                                   |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| Geometry    | `Geometry`, `Part`, `Body`, `polygonGeometry`, `polygonPart`, `computeBounds`, `validateBodies`, `validateElements`, `validatePickIds` | Immutable local positions, indices, optional body/element/node/face metadata, and local bounds.                        |
| Elements    | `createElement`, `ElementModel`, `elementPart`, `ElementShape`                                                                         | Validated linear FE connectivity (point, line, triangle, quad, Tet4, Hex8) and canonical topology/tessellation inputs. |
