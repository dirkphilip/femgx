...
| Elements    | `createElement`, `ElementModel`, `elementPart`, `heterogeneousElementParts`, `boundaryFaceRefs`, `FaceIdRef`, `ElementShape`                                               | Validated linear FE connectivity (point, line, triangle, quad, Tet4, Hex8), canonical topology, mixed primitive grouping, and face selection inputs. |
