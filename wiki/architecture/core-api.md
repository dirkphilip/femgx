...
| Interaction | `createInteractionState`, `InteractionTarget`, `setTargetSelected`, `setTargetHighlighted`, `setTargetsHighlighted`, `clearSelection`, granular `set*`, `resolve*Style` | Immutable selection, highlight, hover, visibility, and style state.                                                                                                                        |
