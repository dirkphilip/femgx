...
| Elements    | `createElement`, `ElementModel`, `elementPart`, `boundaryFaceRefs`, `FaceIdRef`, `ElementShape`                                                                            | Validated linear FE connectivity (point, line, triangle, quad, Tet4, Hex8), canonical topology, and face selection inputs. |
