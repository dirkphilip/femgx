...
| `results/`                    | Authored scalar/vector fields, ranges, color maps, and nodal deformation state. Derived engineering quantities and deferred glyph systems remain out of scope. |
