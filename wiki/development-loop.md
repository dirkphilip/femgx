...
Supervisor command reference lives in [[supervisor-workflow|Supervisor
...
sed -n '1,260p' wiki/todo.md
sed -n '1,260p' wiki/performance-issues.md
```
...
3. Re-read `wiki/todo.md`, `wiki/performance-issues.md`, and relevant design
   notes.
...
work. Update [[todo|Engineering TODO]], [[performance-issues|Performance issues
