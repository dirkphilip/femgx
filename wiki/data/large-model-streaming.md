...
[[engineering/performance-issues|Performance issues]] and the issue tracker.
...
scan quadratic fails the gate (see [[engineering/benchmarks|Benchmarks]]).
Backpressure is
...
Related: [[architecture/instancing-strategy|Instancing strategy]], [[architecture/packed-runtime|Packed
scene runtime]], [[engineering/todo|Engineering TODO]].
