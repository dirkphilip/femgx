...
and alpha `0` contributes no visible color. The pick pass still draws all
visible instances, so opacity does not create click-through or multi-hit
semantics. Per-part order buffers remain deterministic; no CPU sorting or
material clones are needed.
