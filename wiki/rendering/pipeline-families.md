...
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| Instanced triangle, expanded line, and point glyph | [Primitive pipelines](../../src/renderer/shaders/primitive-pipelines.ts); [Selection pipelines](../../src/renderer/shaders/selection-pipelines.ts) | `instancedPrimitiveGeometry` in `src/renderer/shaders/instanced-primitive-geometry.ts` owns the entry point, vertex layout, triangle-list topology, and no-cull state; each caller supplies its role-specific vertex module and pass-local depth comparison. | Opaque color, weighted transparency, four-target picking, dense-selection triangle depth bias, and depth-visible/occluded selection. |
