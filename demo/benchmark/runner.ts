...
const MEMORY_ESTIMATE_SCOPE =
  "retained renderer-owned buffers and fixed render targets including inactive result-color tails; cpuSceneTypedArrayBytes and uploadStagingBytes are reported separately; driver allocations are excluded; edge and topology storage are upper bounds";
