...
| `viewport.setInstanceVisible(id, visible)`           | `viewport.visibility.setInstance(id, visible)`           |
...
The root keeps `scene`, `runtime`, `setScene`, `updateScene`, `batch`,
...
part, assembly, assembly occurrence, or instance throws the exported
