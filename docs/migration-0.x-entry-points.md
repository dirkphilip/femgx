...
| Interaction state, selection, target mapping, and box gestures                                                  | `femgx/interaction`                             | Interaction is a specialist host-owned domain.                                      |
| Authored result fields, ranges, color mapping, and deformation                                                  | `femgx/results`                                 | Results authoring is a specialist host-owned domain.                                |
