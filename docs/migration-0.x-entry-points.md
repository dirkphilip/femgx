...
| `createSceneRuntime`, `SceneRuntime`, `RuntimePartOccurrence`, `RuntimeOccurrence`                              | `femgx/runtime`                                 | CPU runtime inspection is separate from the ordinary viewport workflow.             |
