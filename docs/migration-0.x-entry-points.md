...
| `FemModel`, diagnostics, model builders, `parseVtk`, `writeVtk`, and model-result conversion                    | `femgx/io`       | Serializable FEM and VTK interchange are optional domain concerns.                  |
...
placements in a scene, create `FemViewport`, then apply interaction and authored
